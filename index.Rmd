...
```{r}
centro_america_evida = centro_america[centro_america$lifeExp >= 74,]

plot(centro_america_evida["lifeExp"], main="Paises de Centroamérica con esperanza de vida mayor a 74 años")
```